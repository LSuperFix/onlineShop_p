...
import {plusItem, mimusItem, removeItem} from '../redux/slices/cartSlice'

function CartItem({name, imageUrl, price, sizes, types, count, id}) {
  const dispatch = useDispatch()
  const plusPizza = () => dispatch(plusItem(id))
  const minusPizza = () => dispatch(mimusItem(id))
  const removePizza = () => {
