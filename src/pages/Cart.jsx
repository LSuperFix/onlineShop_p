...
import {clerItems} from '../redux/slices/cartSlice'
import CartEmpty from '../components/CartEmpty'

function Cart() {
  const cartItems = useSelector(state => state.cart.items)// берем все пицы
  const totalPrice = useSelector(state => state.cart.totalPrice)// общая цена всех пиц
  const itemsInCart = cartItems.reduce((sum, item) => sum + item.count, 0)
          ...
          <div className="cart">
            <div className="cart__top">
              ...
              <div className="cart__clear">
                ...
                <span onClick={clerCart}>Очистить корзину</span>
              </div>
            </div>
            <div>
              ...
              <div className="cart__bottom">
                <div className="cart__bottom-details">
                  <span> Всего пицц: <b>{itemsInCart} шт.</b> </span>
